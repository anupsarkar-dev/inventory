      ...
      <div class="row">
         <div class="col-md-12 mr-auto">
            <?php $attributes = array("class" => "", "id" => "stockform", "name" => "stockform");
               echo form_open("stock/stock_present_create", $attributes);?>
            <div class="card card-plain" style="
               ...
               <div class="footer text-center">
                <br/>
                  <input type="submit" class="btn btn-fill btn-neutral btn-wd" id="btn_stock" name="btn_stock" value="Add Stock present" />
               </div>
            </div>
            <?php echo form_close(); ?>
